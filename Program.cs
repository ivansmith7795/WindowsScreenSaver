...
//C# .NET Framework example of a screen saver application for Windows which uses dynamic web page content for screensaver images. Configurable interface uses Windows forms.
...
namespace pl.polidea.lab.Web_Page_Screensaver
{
    ...
    {
        public static readonly string KEY = "Software\\ScreenSaver";
